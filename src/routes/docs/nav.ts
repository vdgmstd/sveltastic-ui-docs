...
export const componentLinks: readonly DocLink[] = [
	...
	{ slug: 'avatar', name: 'Avatar', source: 'Avatar', version: 'v1', category: 'Display', summary: 'User avatar with image fallback, initials, and groups.' },
	{ slug: 'progress', name: 'Progress', source: 'Progress', version: 'v1', category: 'Display', summary: 'Linear and circular determinate progress indicators.' },
	...
	{ slug: 'divider', name: 'Divider', source: 'Divider', version: 'v1', category: 'Display', summary: 'Horizontal or vertical visual separator with optional label.' },
